  ...
  ?>
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="https://source.unsplash.com/2400x700/?coding,coding" class="d-block w-100" alt="...">
            </div>
        </div>
              ...
              while($row=mysqli_fetch_assoc($result))
              {
                  ...
                  <div class="card" style="width: 18rem;">
                      ...
                      <div class="card-body">
                          ...
                          <a href="threads.php?catid=' . $id .'" class="btn btn-primary">View threds</a>
                      </div>
                  </div>
              </div>';
              }
